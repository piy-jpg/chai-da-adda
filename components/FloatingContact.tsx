...
export function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col items-center gap-2.5 sm:gap-3 select-none pointer-events-auto">
      ...
      <motion.a
        ...
        className="relative w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-[#25D366] text-[#0D0806] flex items-center justify-center shadow-[0_8px_25px_rgba(37,211,102,0.4)] hover:shadow-[0_12px_30px_rgba(37,211,102,0.6)] transition-shadow duration-300 group"
      >
        {/* Subtle Pulse Ring */}
